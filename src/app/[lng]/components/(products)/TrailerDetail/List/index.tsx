...
import { Header } from "@/app/[lng]/components/(products)/TrailerDetail/List/Header";
import styles from "@/app/[lng]/components/(products)/TrailerDetail/List/list.module.scss";
...
interface TrailerDetailListProps {
  products: Product[];
}

export const TrailerDetailList: React.FC<TrailerDetailListProps> = ({
  products,
}) => {
